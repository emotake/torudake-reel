...
編集開始時にInstagram Reels、YouTube Shorts、または両方を投稿先として
選択できます。同じ文字起こし・編集結果から3種類のテロップ仕上げを端末内で
比較し、Instagram投稿文とYouTube Shorts用タイトル・説明文を追加のAI処理なしで
用意します。YouTube Shorts用タイトルは100文字以内に整えます。
