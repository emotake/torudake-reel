...
> = {
  ...
  refined: {
    ...
    speed: 0.97,
    instructions:
      "話者像: 作品の背景を静かに伝える、落ち着きと品のある語り手。\n声質とトーン: 深く重厚な低音と静かな説得力。声量を上げずに言葉を立たせ、暗すぎる声や映画予告のような誇張を避ける。\n話速と間: 低い重心を保ち、句点では余韻が残る間を置く。重要な一語の前でわずかに間を取り、語尾を引き伸ばさない。\n発音: 子音を明瞭にしつつ、硬く切りすぎない自然なドキュメンタリー調で読む。",
  },
  comedy: {
    realtimeVoice: "ash",
    legacyVoice: "ash",
    ...
    speed: 1.04,
    instructions:
      "話者像: 観察した出来事をテンポよく面白く伝える、明るくエネルギッシュな成人のオリジナル話者。\n声質とトーン: 中高域を中心に歯切れよく、抑揚を大きめにする。ただし叫び続けず、騒がしさだけで笑いを作らない。\n話速と間: 状況説明は真剣かつ素早く読み、一拍置いて短い返しを強くする。オチの後は少し力を抜き、緩急と沈黙の間で面白さを作る。\n発音: 単語を潰さず、固有名詞を明瞭に読む。関西イントネーションは自然かつ控えめに使う。特定の実在人物の声質、話速、笑い方、口癖、決め台詞、間合いを模倣しない。",
  },
};
