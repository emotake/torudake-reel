...
const STYLE_INSTRUCTIONS: Record<NarrationStyle, string> = {
  ...
  tempo:
    "萌えアニメキャラクター風。明るい驚き、可愛いリアクション、感情の急な切り替えを短文で表す。実在作品の台詞やキャラクターは模倣しない",
  refined: "深い低音に合う静かな説得力。簡潔で重みのある語彙を使う",
  comedy:
    "激しい関西芸人風。妙に真剣な状況説明→一拍→鋭いツッコミ、または予想外の短いオチで畳みかける。状況説明は標準語または薄い関西弁、短いツッコミとオチだけ自然な関西弁にして落差を作る",
};
...
export async function POST(request: Request) {
  ...
  const characterRules =
    style === "comedy"
      ? `
- 「関西ツッコミ」では、冒頭3秒以内に最初のボケを置き、「妙に真剣な実況→一拍→短く激しい関西弁のツッコミ／オチ」の落差を必ず作ってください。実在する芸人の口癖は使わないでください。
- 誇張は比喩と言い回しだけに使い、商品情報・効果・価格・実績は誇張しないでください。笑いの矛先は状況か語り手自身に限定し、人物の容姿・属性・失敗を嘲笑しないでください。流行語・ダジャレ・同じツッコミを連発しないでください。`
      : style === "tempo"
        ? `
- 「萌えアニメ」では、短い驚きや喜び、可愛いリアクション、感情の急な切り替えを入れてください。ただし幼児語を多用せず、内容と固有名詞は明瞭にしてください。
- 実在する作品・声優・キャラクターの決め台詞や話し方は模倣しないでください。`
      : "";
  const content: Array<
