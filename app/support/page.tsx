...
export const metadata = buildPublicPageMetadata({
  ...
  description:
    "撮るだけリールの決済・解約、保存失敗、LINEログイン、二重請求・返金に関するご案内です。",
  path: "/support",
});
  ...
  return (
    <>
      ...
      <article>
        <h2>LINEログインで困った</h2>
        <p>
          新しいアカウントはLINEで作成します。LINEログインをキャンセルした場合は、もう一度「LINEでログイン」を押してください。LINEアカウントを利用できない場合や、ログイン後に元の購入履歴が表示されない場合は、下のお問い合わせ先へご相談ください。本人確認なしにアカウントの復旧や利用者の変更は行いません。
        </p>
      </article>
