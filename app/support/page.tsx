...
export const metadata = buildPublicPageMetadata({
  ...
  description:
    "撮るだけリールの決済・解約、保存失敗、パスキー紛失、二重請求・返金に関するご案内です。",
  path: "/support",
});
...
export default function SupportPage() {
  return (
    <>
      ...
      <article>
        <h2>パスキーを登録した端末を紛失した</h2>
        <p>
          別の登録済み端末があれば、その端末からログインしてください。登録済み端末が1台も使えない場合は、下のお問い合わせ先へご相談ください。安全確認なしにログインを解除することはありません。
        </p>
      </article>
