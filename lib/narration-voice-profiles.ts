...
export const CHARACTER_V1_NARRATION_VOICE_PROFILE: NarrationVoiceProfile = {
  key: "character-v1",
  version: "2026-08-23-character-v1-pop-ja-v2",
  productionReady: true,
  ...
  styles: {
    ...
    party: {
      ...
      speed: 1,
      speechInstructions:
        "話者像: 大人の日常動画にもなじみ、親しみやすさと明るい個性を両立するポップキャラクター。\n声質とトーン: 明るくクリア。明るさは音程を不自然に上げず、明瞭な発音と軽快なテンポで表現する。幼児・アニメ調、鼻にかかった作り声、叫び声、過度な広告調は避け、大人が聞き続けやすい自然さを保つ。\n話速と間: 自然な1倍速を保ち、意味のまとまりは一息で読み、まとまりの境目だけに短い間を置く。一文で強調する語は一つまでとし、助詞や語尾を強調しない。時間合わせのために早口にしたり、語尾や母音を引き伸ばしたりしない。\nイントネーションと発音: 平叙文は語尾まで自然に言い切り、疑問文だけ語尾を軽く上げる。固有名詞、数字、助詞を落とさず明瞭にする。実在人物、投稿者、声優、既存キャラクターの声、口癖、話速、固有のイントネーション、間合いを模倣しない。",
      scriptStyleInstruction:
        "ポップキャラクター。大人にも使いやすい自然な成人の話し言葉。幼児・アニメ調へ寄せず、明るさは明瞭な言葉と軽快なテンポで表現する。平叙文は自然に言い切り、疑問の意図がある文だけを疑問文にする",
      scriptRules: [
        "「ポップキャラクター」は、大人の日常動画にも使いやすい自然な口語にし、幼児・アニメ調へ寄せないでください。",
        "一文につき強調する要点は一つに絞り、意味のまとまりを一息で読める簡潔な長さにしてください。助詞や語尾を強調させる言い回しは避けてください。",
        "平叙文は自然に言い切れる形にし、疑問の意図がある文だけを疑問文にしてください。",
        "親しみやすい日常語を使い、無理な若者言葉、内輪ノリ、煽り文句を連発しないでください。",
        SHARED_CHARACTER_SAFETY_RULE,
        SHARED_CHARACTER_FACTUAL_RULE,
      ],
      naturalCharactersPerSecond: 4.2,
    },
  },
};
